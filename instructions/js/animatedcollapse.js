...
expandAnchor:function(optionalSuffixToIgnore){

  var anchor = location.hash;
  anchor = anchor.substr(1, anchor.length - 1);

  if (optionalSuffixToIgnore !== undefined) {
    var suffixPos = anchor.indexOf(optionalSuffixToIgnore, anchor.length - optionalSuffixToIgnore.length);
    if (suffixPos !== -1) {
        // strip the suffix
        anchor = anchor.substring(0, anchor.length - optionalSuffixToIgnore.length);
    }
  }
